...
class TweetAnalysis(MRJob):
    ...
    def reducer(self, key, values):
        ...
        # Output the results
        output1 = f"Joe Biden    likes: {biden_likes}    retweets: {biden_rets}      Twitter for web: {biden_web}    Twitter for iPhone: {biden_iphone}      Twitter for Android: {biden_android}"
        output2 = f"Donald Trump    likes: {trump_likes}    retweets: {trump_rets}      Twitter for web: {trump_web}    Twitter for iPhone: {trump_iphone}      Twitter for Android: {trump_android}"
        output3 = f"Both Candidates     likes: {both_likes}     retweets: {both_rets}       Twitter for web: {both_web}     Twitter for iPhone: {both_iphone}       Twitter for Android: {both_android}"
